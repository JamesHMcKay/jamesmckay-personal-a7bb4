...
sections:
  - type: hero_section
    ...
    subtitle: >-
      From simple presentation to complex modelling, I develop code that helps
      make insights that are robust, automated and reliable.
    actions:
      - label: Contact Me
        url: /contact
        style: primary
    ...
    image: images/profile_downsized.png
